...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAIControl : CarControl
    {
        ...
        public void AvoidMineAction(GameObject objectObstacle)
        {
            ...
            Debug.Log("Ѕлижний угол " + (nearAngle < avoidFarAngle));
            Debug.Log("ƒaльний угол " + (farAngle < avoidFarAngle));
        ...
        private void SetAbilityTarget(Transform abilityTarget)
        {
            if (abilityTarget != null)
            {
                ...
                m_Driving = true;
                //randomMove = false; //что бы не промахнутьс€ убираем шум
            }
            abilitiesPoints.RemoveAt(0);
        }
        ...
        private bool ReachabilityCheck(Vector3 checkedObject)
        {
            ...
            if (angle > 10) //если угол больше значени€, то цель не достижима
            {
                return false;
            }
            return true;
